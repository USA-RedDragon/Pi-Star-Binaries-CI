...
http_archive(
    ...
    url = "https://github.com/bazelbuild/rules_foreign_cc/archive/f68b351c4691e747f889dc5e4c2cac3cd3b66ea2.tar.gz",
)
...
http_archive(
    ...
    urls = [
        ...
        "https://github.com/bazelbuild/rules_pkg/releases/download/1.3/rules_pkg-0.10.1.tar.gz",
    ],
